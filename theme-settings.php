...
function register_settings()
{
    ...
    // Add settings section
    add_settings_section( 'footer_section', 'Footer Settings', 'display_section', 'theme_settings.php' );

    // Add settings section
    add_settings_section( 'portfolio_section', 'Portfolio Settings', 'display_section', 'theme_settings.php' );

    // Add settings section
    add_settings_section( 'publication_section', 'Publication Settings', 'display_section', 'theme_settings.php' );
...
/* 
  ...
  =============================== */
    ...
    $field_args = array(
      'type'      => 'text',
      'id'        => $pre. 'portfolio_tagline',
      'desc'      => 'Portfolio Tagline',
      'std'       => '',
      'label_for' => 'text',
    );

    add_settings_field( 'text', 'Portfolio Tagline', 'display_setting', 'theme_settings.php', 'portfolio_section', $field_args );
  ...
  =============================== */
    ...
    $field_args = array(
      'type'      => 'text',
      'id'        => $pre. 'publication_tagline',
      'desc'      => 'Publications Tagline',
      'std'       => '',
      'label_for' => 'text',
    );

    add_settings_field( 'text', 'Publications Tagline', 'display_setting', 'theme_settings.php', 'publication_section', $field_args );
    ...
    // add_settings_field( 'map', 'Google Map', 'display_setting', 'theme_settings.php', 'contact_section', $field_args );
    ...
    $field_args = array(
      'type'      => 'textarea',
      'id'        => $pre. 'contact',
      'desc'      => 'An address for the business',
      'std'       => '',
      'label_for' => 'textbox',
    );

    add_settings_field( 'address', 'Address', 'display_setting', 'theme_settings.php', 'footer_section', $field_args );    
    ...
    $field_args = array(
      ...
      'post_type' => 'page',
      'id'        => $pre. 'cookie',
      'desc'      => 'Select a page for your cookie policy',
      'std'       => '',
      'label_for' => 'textbox',
    );

    add_settings_field( 'cookie', 'Cookie Policy', 'display_setting', 'theme_settings.php', 'footer_section', $field_args );
    ...
    $field_args = array(
      ...
      'post_type' => 'page',
      'id'        => $pre. 'privacy',
      'desc'      => 'Select a page for your privacy policy',
      'std'       => '',
      'label_for' => 'textbox',
    );

    add_settings_field( 'privacy', 'Privacy Policy', 'display_setting', 'theme_settings.php', 'footer_section', $field_args );
